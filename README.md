...
* [Pavo's OpenCore Builder v1.7 ](https://github.com/MacProDude/ocbuilder-1/releases/tag/1.7) Creates a Basic EFI Structure with Basic Kexts which are needed to Boot **XCODE App is required**
