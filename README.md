...
# Debugging Notes
* **(File logging is saved as a ***opencore-YYYY-MM-DD-HHMMSS.txt*** or .log file on root of EFI partition). (DEBUG or NOOPT Version of OpenCore maybe required for more detailed log output, see Configuration.pdf for further information under troubleshooting)  (Also Boot-arg -keepsyms must be added also for Verbose Booting ) Further information will be added to this guide soon.** 
